...
### 프론트
#### git clone https://github.com/kimtaegun-lang/realtime-detection-dashboard-frontend
#### docker build -t frontend .
#### docker run -p 5173:5173 frontend


### 백엔드
#### git clone https://github.com/kimtaegun-lang/realtime-detection-dashboard-backend
